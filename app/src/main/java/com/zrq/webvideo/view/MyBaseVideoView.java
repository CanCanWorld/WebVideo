 ...
 */
public class MyBaseVideoView<P extends AbstractPlayer> extends FrameLayout
    ...
    @Nullable
    protected MyAudioFocusHelper mAudioFocusHelper;
    ...
    public MyBaseVideoView(@NonNull Context context) {
        this(context, null);
    }

    public MyBaseVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyBaseVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * 设置{@link #mPlayerContainer}的背景图片
     */
    ...
    protected boolean startPlay() {
        ...
        if (mEnableAudioFocus) {
            mAudioFocusHelper = new MyAudioFocusHelper(this);
        }
        //读取播放进度
     ...
     * 音频焦点，此播放器将做出相应反应，具体实现见{@link MyAudioFocusHelper}
     */
